...
class CompileRunManager {
    ...
    run(shouldAskForArgs = false, shouldRunInExternalTerminal = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const file = yield this.getFile();
            if (file === null) {
                return;
            ...
            yield runner.run(shouldRunInExternalTerminal);
        });
    }
    compileRun(shouldAskForInputFlags = false, shouldAskForArgs = false, shouldRunInExternalTerminal = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const file = yield this.getFile();
            if (file === null) {
                return;
    ...
    getFile() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!vscode_1.window || !vscode_1.window.activeTextEditor || !vscode_1.window.activeTextEditor.document) {
                notification_1.Notification.showErrorMessage('Invalid document!');
                return null;
            }
            ...
            if ((doc === null || doc === void 0 ? void 0 : doc.isUntitled) && !configuration_1.Configuration.saveBeforeCompile()) {
                notification_1.Notification.showErrorMessage('Please save file first then try again!');
                return null;
            }
