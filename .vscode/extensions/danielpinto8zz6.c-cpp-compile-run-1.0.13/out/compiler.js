...
class Compiler {
    ...
    compile() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield common_utils_1.isProccessRunning(this.file.executable)) {
                notification_1.Notification.showErrorMessage(`${this.file.executable} is already runing! Please close it first to compile successfully!`);
                return result_1.Result.error;
            }
            ...
            if (proccess.status === 0) {
                notification_1.Notification.showInformationMessage('Compiled successfuly!');
            }
            else {
                output_channel_1.outputChannel.show();
                notification_1.Notification.showErrorMessage('Error compiling!');
                return result_1.Result.error;
            }
    ...
    setCompiler() {
        switch (this.file.type) {
            ...
            default: {
                notification_1.Notification.showErrorMessage('Invalid File!');
                return result_1.Result.error;
            }
        }
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (choiceForDetails === CHANGE_PATH) {
                ...
                if (yield this.isCompilerValid(this.compiler)) {
                    ...
                    notification_1.Notification.showErrorMessage('Compiler not found!');
                }
            }
            else {
                notification_1.Notification.showErrorMessage('Compiler not set!');
            }
        });
    }
}
