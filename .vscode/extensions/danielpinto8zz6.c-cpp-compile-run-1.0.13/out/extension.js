...
function activate(context) {
    ...
    const run = vscode_1.commands.registerCommand('extension.Run', () => __awaiter(this, void 0, void 0, function* () {
        yield compileRunManager.run(false, configuration_1.Configuration.runInExternalTerminal());
    }));
    const compileRun = vscode_1.commands.registerCommand('extension.CompileRun', () => __awaiter(this, void 0, void 0, function* () {
        yield compileRunManager.compileRun(false, false, configuration_1.Configuration.runInExternalTerminal());
    }));
    ...
    const customCompileRun = vscode_1.commands.registerCommand('extension.CustomCompileRun', () => __awaiter(this, void 0, void 0, function* () {
        yield compileRunManager.compileRun(true, true, configuration_1.Configuration.runInExternalTerminal());
    }));
    const compileRunInExternalTerminal = vscode_1.commands.registerCommand('extension.CompileRunInExternalTerminal', () => __awaiter(this, void 0, void 0, function* () {
        yield compileRunManager.compileRun(false, false, true);
    }));
