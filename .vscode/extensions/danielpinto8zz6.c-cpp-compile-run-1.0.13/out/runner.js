...
class Runner {
    ...
    run(shouldRunInExternalTerminal = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!fs_1.existsSync(this.file.path)) {
                notification_1.Notification.showErrorMessage(`"${this.file.path}" doesn't exists!`);
            ...
            switch (process.platform) {
                ...
                case 'linux':
                    ...
                    if (string_utils_1.isStringNullOrWhiteSpace(linuxTerminal)
                        ...
                        notification_1.Notification.showErrorMessage(`${terminal_1.terminal} not found! Try to enter a valid terminal in 'terminal.external.linuxExec' `
                    ...
                    switch (linuxTerminal) {
                        ...
                        default:
                            notification_1.Notification.showErrorMessage(`${linuxTerminal} isn't supported! Try to enter a supported terminal in `
                                + `'terminal.external.linuxExec' settings! (gnome-terminal, xterm, konsole)`);
                            return null;
                    }
                default:
                    notification_1.Notification.showErrorMessage('Unsupported platform!');
                    return null;
            }
        });
    }
