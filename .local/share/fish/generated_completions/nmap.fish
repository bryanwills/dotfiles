...
complete -c nmap -o Pn --description 'to skip host discovery and port scan all target addresses.'
...
complete -c nmap -l discovery-ignore-rst --description '.'
complete -c nmap -l traceroute --description '.'
complete -c nmap -s n --description 'Tells Nmap to never do reverse DNS resolution on the active IP addresses it f…'
