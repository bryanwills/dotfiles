# iperf
# Autogenerated from man page /usr/local/share/man/man1/iperf.1
complete -c iperf -s b -l bandwidth --description 'set the target bandwidth and optional standard devation per <mean>,[<stdev>] …'
complete -c iperf -s e -l enhanced --description 'Display enhanced output in reports otherwise use legacy report (ver 2. 0.'
complete -c iperf -s f -l format --description 'format to report: adaptive, bits, Bytes, Kbits, Mbits, Gbits, KBytes, MBytes,…'
...
complete -c iperf -s z -l realtime --description 'Request real-time scheduler, if supported.'
complete -c iperf -s B -l bind --description 'bind to host, ip address or multicast address and optional port (see notes).'
...
complete -c iperf -s H -l ssm-host --description 'Set the source host (ip addr) per SSM multicast, i. e.  the S of the S,G.'
...
complete -c iperf -s r -l tradeoff --description 'Do a bidirectional test individually - client-to-server, followed by a revers…'
...
complete -c iperf -s L -l listenport --description 'port to recieve bidirectional tests back on.'
...
complete -c iperf -s Z -l linux-congestion --description 'set TCP congestion control algorithm (Linux only) EXAMPLES.'
complete -c iperf -l ---------------------------------------------------------- --description '.'
