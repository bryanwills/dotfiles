...
complete -c highlight -l syntax-by-name --description 'specify type of source code by given name.'
complete -c highlight -s v -l verbose --description 'print debug info to stderr.'
complete -c highlight -s q -l quiet --description 'suppress progress info in batch mode.'
...
complete -c highlight -l max-size --description 'set maximum input file size (examples: 512M, 1G; default: 256M).'
...
complete -c highlight -s s -l style --description 'set highlighting style (theme).  Add \'base16/\' prefix to use a Base16 theme.'
...
complete -c highlight -l isolate --description 'output each syntax token in separate tags (verbose output).'
...
complete -c highlight -l no-trailing-nl --description 'omit trailing newline.  If mode is "empty-file", omit only for empty input.'
