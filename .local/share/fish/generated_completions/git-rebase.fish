...
complete -c git-rebase -l no-keep-empty --description 'Do not keep commits that start empty before the rebase (i. e.'
...
complete -c git-rebase -l no-gpg-sign --description 'GPG-sign commits.'
complete -c git-rebase -l reset-author-date --description 'Instead of using the author date of the original commit, use the current time…'
