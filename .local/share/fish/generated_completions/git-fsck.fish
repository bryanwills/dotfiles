# git-fsck
# Autogenerated from man page /Library/Developer/CommandLineTools/usr/share/man/man1/git-fsck.1
...
complete -c git-fsck -l connectivity-only --description 'Check only the connectivity of reachable objects, making sure that any object…'
